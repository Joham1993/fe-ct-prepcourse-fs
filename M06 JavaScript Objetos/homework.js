...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   //var objetoMisterioso = {numeroMisterioso: x, masPropiedades: y};
...
function eliminarPropiedad(objeto, propiedad) {
   ...
   // Tu código:
   //var objeto = {propiedad: x, masPropiedades: y};
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   // var objetoUsuario = {email: x};
   for (let prop in objetoUsuario){
      if(prop=="email"){
         comprovacion = objetoUsuario.email;
      }
   }
...
function tienePropiedad(objeto, propiedad) {
   ...
   // Tu código:
   var tienePropiedad;
   tienePropiedad = objeto.hasOwnProperty(propiedad);
